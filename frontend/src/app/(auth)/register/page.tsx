    ...
    try {
      ...
      if (!response.ok) {
        ...
        try {
          ...
          errorMessage = parseApiError(data);
        } catch {
          // Non-JSON response (e.g., 500 Internal Server Error)
          ...
          <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-card/80 backdrop-blur-xl border border-border shadow-2xl p-6 md:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5 relative z-10">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="displayName" className="text-xs font-medium text-muted-foreground uppercase tracking-wider ml-1">
                  Name (optional)
                </Label>
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-muted-foreground ml-1">
                  8-128 characters with letters, numbers, and symbols
                </p>
              </div>
